...
const StudentModal = ({ isOpen, onClose, onSubmit, initialData = null }) => {
    const defaultData = {
        name: '', email: '', class_name: '', grade: '', subject: '', tutor: '', location: '', country: '', status: 'Active'
    };
                ...
                <form onSubmit={handleSubmit} className="modal-form">
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input type="email" className="form-input" name="email" value={formData.email} onChange={handleChange} required placeholder="student@example.com" />
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-group">
