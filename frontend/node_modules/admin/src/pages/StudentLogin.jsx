            ...
            <div className="login-side-form">
                <div className="login-form-container">
                    ...
                    <form onSubmit={handleLogin} className="login-form">
                        ...
                        <button
                            type="submit"
                            className="btn-login-v2 bg-[#22c55e] hover:bg-emerald-600 shadow-lg shadow-emerald-900/20"
                            disabled={loading}
                        >
                        ...
                        <div className="flex flex-col gap-2 mt-8">
                            <div className="flex justify-between items-center text-[0.85rem]">
                                <span className="text-[#6a6d7a]">Portal Access:</span>
                                <div className="flex gap-4">
                                    <button onClick={() => navigate('/login/admin')} className="text-blue-500 hover:text-blue-400 font-semibold transition-colors">Admin</button>
                                    <button onClick={() => navigate('/login/teacher')} className="text-emerald-500 hover:text-emerald-400 font-semibold transition-colors">Teacher</button>
                                </div>
                            </div>
                        </div>
                </div>
